      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              >
                Full-Stack Engineer • MERN & Python • Technical Mentor
              </p>
            </motion.div>
            ...
            <motion.p
              ...
              style={{ color: themeColors.summeryText }}
            >
              I design and build scalable web applications by blending
              thoughtful UI design with solid engineering, performance, and
          ...
          <div className="flex flex-col items-center lg:items-end">
            ...
            >
              <p
                ...
                style={{ color: themeColors.summeryText }}
              >
                Let’s stay connected — I share development insights, design
                experiments, and lessons learned from real-world projects.
              </p>
          ...
          >
            <p
              ...
              style={{ color: themeColors.summeryText }}
            >
              Open to freelance projects, technical consulting, or a thoughtful
              tech conversation.
            </p>
            ...
            <motion.a
              ...
              aria-label="Start a conversation on LinkedIn"
              ...
              whileHover={{
                y: -2,
                boxShadow: `0 6px 24px -6px ${themeColors.primaryColor}`,
              }}
              whileTap={{ scale: 0.97 }}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          >
            ...
            · Engineered with purpose, crafted with care.
          </motion.p>
