  ...
  return (
    <div className="w-full lg:w-1/2 mx-auto shrink-0 lg:mx-0 py-8 lg:py-12 order-2 lg:order-1 text-center lg:text-left">
        ...
        <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-2 sm:space-y-0 sm:space-x-6 items-center lg:items-start">
          <span
            ...
            style={{
              ...
              border: `3px solid ${themeColors.primaryColor}33`,
      ...
      <div className="mt-6 sm:mt-4">
        ...
        >
          Hey! I'm{" "}
          <span style={{ color: themeColors.primaryColor }}>Dimal Thomas</span>, a{" "}
          <span>
            <Typewriter
              options={{
                strings: ["Full-Stack  (5+ Years)" , "Industry Mentor & Hiring-Oriented Trainer" ," MERN & Python Full-Stack Specialist"],
                autoStart: true,
                loop: true,
              }}
            />
