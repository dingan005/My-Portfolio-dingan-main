    ...
    >
      <div className="max-w-screen-xl mx-auto px-4 py-24">
        <SectionHeader
          ...
          subtitle="Have a project in mind or looking to collaborate? I'm always open to meaningful conversations and new opportunities."
        />
            ...
            {[
              {
                icon: "Mail",
                title: "Email",
                value: "dimalthomas@gmail.com",
                href: "mailto:dimalthomas@gmail.com",
              },
              {
                icon: "Phone",
                title: "Phone",
                value: "+91-9048660807",
                href: "tel:+919048660807",
              },
              {
                icon: "MapPin",
                title: "Location",
